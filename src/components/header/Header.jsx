...
const Header = ({ type }) => {
  ...
  return (
    <div className="header">
      <div
        className={
          type === "list" ? "headerContainer headerListMode" : "headerContainer"
        }
      >
        ...
        {type !== "list" && (
          <>
            ...
            <p className="headerDes">
              Get rewarded for your travels - unloack instant saving of 10% or
              more with a free <span className="underline">DeepHotels</span>{" "}
              account.
            </p>
